...
pub fn save_wifi_config(nvs: &mut EspNvs<NvsDefault>, ssid: &str, password: &str) -> bool {
...
pub fn save_api_key(nvs: &mut EspNvs<NvsDefault>, key: &str) -> bool {
    if nvs.set_str("api_key", key).is_err() { return false; }
    info!("API key saved");
    true
}

pub fn save_channel(nvs: &mut EspNvs<NvsDefault>, channel: &str) -> bool {
